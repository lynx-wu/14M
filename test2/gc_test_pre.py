...
train_dir = '/media/disk/Backup/02drive/17qiulin/gc/Fundus_Scanes_Sorted/Train'
val_dir = '/media/disk/Backup/02drive/17qiulin/gc/Fundus_Scanes_Sorted/Validation'
...
if __name__ == '__main__':
    ...
    model = CustomResNet18(dropout_rate=0.5, model_path=None).to(device)
    print('test')
    train_loader,val_loader = train_val_data_process(train_dir, val_dir, max_samples_per_class=1000)
    print('test1')
